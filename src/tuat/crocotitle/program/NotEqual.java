...
public class NotEqual extends Tile {
	...
	public NotEqual(Context mContext, int argumentTileTypeId) {
		super(mContext, argumentTileTypeId);
		frame.setImageResource(R.drawable.not_equal);
	...
	public NotEqual(Context mContext, int argumentTileTypeId, AttributeSet attrs) {
