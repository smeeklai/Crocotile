...
public class LowerThanOrEqualTo extends Tile {
	ValueBox valueBox1;
	ValueBox valueBox2;
	//int height,width;
	FrameLayout.LayoutParams valueBox1MarginParams;
	FrameLayout.LayoutParams valueBox2MarginParams;
	public LowerThanOrEqualTo(Context mContext, int argumentTileTypeId) {
		super(mContext, argumentTileTypeId);
		frame.setImageResource(R.drawable.lower_equal);
