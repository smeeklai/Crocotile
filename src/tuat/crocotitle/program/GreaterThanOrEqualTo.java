...
public class GreaterThanOrEqualTo extends Tile {
	ValueBox valueBox1;
	ValueBox valueBox2;
	//int height,width;
	FrameLayout.LayoutParams valueBox1MarginParams;
	FrameLayout.LayoutParams valueBox2MarginParams;
	public GreaterThanOrEqualTo(Context mContext, int argumentTileTypeId) {
		super(mContext, argumentTileTypeId);
		frame.setImageResource(R.drawable.greater_equal);
